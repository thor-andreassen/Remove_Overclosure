...
figure()
p1=patch('Faces',face_list1,'Vertices',geom1.vertices,'FaceColor','interp','EdgeAlpha',.5,'FaceVertexCData',CData_vec');
...
% color_set=jet(size(CData,1));
% color_set=color_set(CData_vec,:);
p2=patch('Faces',geom2.faces,'Vertices',geom2.vertices,'FaceColor','interp','EdgeAlpha',.5,'FaceVertexCData',CData_vec');
